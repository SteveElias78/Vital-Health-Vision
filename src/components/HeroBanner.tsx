...
export function HeroBanner() {
  return <section className="w-full">
      ...
      <div className="container mx-auto -mt-20 flex items-center justify-center gap-x-12 relative z-10 animate-fade-in">
        <Button className="text-amber-400 hover:shadow-[0_0_15px_rgba(251,191,36,0.7)] transition-all duration-300 px-8 py-6 text-lg font-medium mx-[100px] bg-transparent rounded-lg">
          Explore Data
        </Button>
