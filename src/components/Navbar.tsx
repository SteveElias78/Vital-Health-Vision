...
export function Navbar() {
  ...
  return <nav className="border-b bg-white shadow-sm">
      ...
      {/* Mobile Navigation */}
      <div className={cn("fixed inset-0 z-50 bg-white p-4 md:hidden transition-transform duration-300 ease-in-out", isOpen ? "translate-x-0" : "translate-x-full")}>
        ...
        <div className="flex flex-col space-y-4 mt-8">
          <Link to="/" className="text-xl font-medium text-gray-800" onClick={toggleMenu}>
            Dashboard
          </Link>
          <Link to="/explore" className="text-xl font-medium text-gray-800" onClick={toggleMenu}>
            Explore Data
          </Link>
          <Link to="/predict" className="text-xl font-medium text-gray-800" onClick={toggleMenu}>
            Predictions
          </Link>
          <Link to="/about" className="text-xl font-medium text-gray-800" onClick={toggleMenu}>
            About
          </Link>
          <div className="pt-4">
