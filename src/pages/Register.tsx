    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gold-300 mt-2">Create your account</p>
        </div>
        
        <div className="art-deco-card p-6">
          <form>
            <div className="mb-4">
              <label htmlFor="name" className="block text-gold-300 mb-1">Full Name</label>
              <Input
                id="name"
                type="text"
            ...
            <div className="mb-6">
              <label htmlFor="confirmPassword" className="block text-gold-300 mb-1">Confirm Password</label>
              <Input
                id="confirmPassword"
                type="password"
                className="art-deco-input w-full"
            ...
            <div className="text-center text-gold-300">
              <p>Already have an account? <Link to="/login" className="text-gold-400 hover:underline">Sign In</Link></p>
            </div>
          </form>
        </div>
      </div>
